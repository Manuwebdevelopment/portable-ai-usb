#!/bin/bash
# Portable AI USB Launcher for Fedora
# Usage: ./start-fedora.sh [--help] [--port <port>]
...
PORT=11434
QUIET=false
LOG_FILE="/tmp/ollama-launch-fedora.log"
...
log_info "Portable AI USB Launcher for Fedora"
