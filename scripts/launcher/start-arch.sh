#!/bin/bash
# Portable AI USB Launcher for Arch Linux
# Usage: ./start-arch.sh [--help] [--port <port>]
...
PORT=11434
QUIET=false
LOG_FILE="/tmp/ollama-launch-arch.log"
...
log_info "Portable AI USB Launcher for Arch Linux"
