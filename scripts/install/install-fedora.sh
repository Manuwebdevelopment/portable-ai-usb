#!/bin/bash
# Portable AI USB Installer for Fedora
...
PORT=11434
MODEL="qwen2.5"
LOG_FILE="/tmp/ollama-install-fedora.log"
...
log_info "Portable AI USB Installer for Fedora"
...
install_ollama() {
    ...
    # Download Ollama for current architecture
    ARCH=$(uname -m)
...
Ollama has been successfully installed on Fedora!
